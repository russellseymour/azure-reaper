...
namespace Azure.Reaper
{
    ...
    public class Entity<T>
    {
        ...
        private string BuildSQLStatement(dynamic identifier, dynamic fields = null)
        {
            ...
            whereClause = String.Join(String.Format(" {0} ", joinOperator), criteria.ToArray());
            sqlStatement = String.Format("SELECT * FROM {0} t WHERE {1}", this.collectionName, whereClause);
